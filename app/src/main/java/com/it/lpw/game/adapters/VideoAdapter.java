...
import com.it.lpw.game.ui.activity.YTVideoActivity;

import java.util.List;

public class VideoAdapter extends RecyclerView.Adapter<VideoAdapter.ViewHolder> {
    LayoutInflater inflater;
    List<VideoResponse.DataItem> dataItems;
    Context contx;

    public VideoAdapter(Context ctx, List<VideoResponse.DataItem> dataItems) {
