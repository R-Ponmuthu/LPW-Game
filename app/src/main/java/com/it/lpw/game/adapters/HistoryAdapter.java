package com.it.lpw.game.adapters;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    List<HistoryResponse.DataItem> dataItems;
    Context contx;

    public HistoryAdapter(Context ctx, List<HistoryResponse.DataItem> dataItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.row_point_history, parent, false);
