...
import com.it.lpw.game.adapters.RedeemAdapter;
...
import com.it.lpw.game.databinding.ActivityWithdrawBinding;
import com.it.lpw.game.util.RecyclerTouchListener;
            ...
            public void onClick(View view, int position) {
                ...
                send.setOnClickListener(v->{
                    if(txt.getText().toString().isEmpty()){
                        ...
                        Constant_Api.P1 = txt.getText().toString().trim();
                        ...
                        Call<CreditResponse> call = ApiClient.getClient(WithdrawActivity.this).create(ApiInterface.class)
                                .Redeem();
