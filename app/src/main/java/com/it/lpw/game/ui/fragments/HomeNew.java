...
import com.it.lpw.game.databinding.FragmentHomeNewBinding;
...
public class HomeNew extends Fragment implements MaxAdViewAdListener, MaxAdRevenueListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dialog = Method.loading(getActivity());
...
//                        showInterAds();
    ...
    private void dailycheckin() {
        showDialog();
        Call<CreditResponse> call = ApiClient.getClient(getActivity()).create(ApiInterface.class).getDailyCheckin();
