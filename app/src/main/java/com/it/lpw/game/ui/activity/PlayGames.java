...
import com.it.lpw.game.databinding.ActivityPlayGamesBinding;
...
import com.it.lpw.game.util.SimpleCountDownTimer;
...
//            showads();
    ...
    private void credit() {
        Constant_Api.TID=id;
        Call<CreditResponse> call= ApiClient.getClient(this).create(ApiInterface.class).GameReward();
