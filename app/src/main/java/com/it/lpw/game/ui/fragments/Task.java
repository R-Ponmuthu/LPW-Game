...
import com.it.lpw.game.adapters.AppAdapter;
...
import com.it.lpw.game.databinding.FragmentHomeBinding;
...
public class Task extends Fragment  implements  MaxAdViewAdListener, MaxAdRevenueListener {
    ...
    private void installApp(String appId) {
        showDialog();
        Constant_Api.TID=appId;
        Call<CreditResponse> call= ApiClient.getClient(getActivity()).create(ApiInterface.class).CreditApp();
