...
public class Method {
    ...
    public static String Obj(Activity activity) {
        ...
        jsObj.addProperty("sal", Method.md5(encrypt(BuildConfig.API_KEY) + salt));
        jsObj.addProperty("sig", salt);
        jsObj.addProperty("_mid", session.User_id());
        ...
        if (Constant_Api.API_TYPE.equals("signup")) {
            ...
            Constant_Api.P4 = "";
            Constant_Api.P5 = "";
        } else if (Constant_Api.API_TYPE.equals("join_game")) {
            jsObj.addProperty("game_type", Constant_Api.P6);
            jsObj.addProperty("game_id", Constant_Api.P2);
            jsObj.addProperty("chosen_option", Constant_Api.P3);
            jsObj.addProperty("matches", Constant_Api.P4);
            jsObj.addProperty("credits", Constant_Api.P5);
            jsObj.addProperty("deduct", Constant_Api.P7);
            Constant_Api.P1 = "";
            Constant_Api.P2 = "";
            Constant_Api.P3 = "";
            Constant_Api.P4 = "";
            ...
            Constant_Api.P8 = "";
            Constant_Api.API_TYPE = "";
        } else if (Constant_Api.API_TYPE.equals("update_game")) {
            jsObj.addProperty("game_id", Constant_Api.P2);
            jsObj.addProperty("matches", Constant_Api.P3);
            jsObj.addProperty("credits", Constant_Api.P4);
            Constant_Api.P1 = "";
            Constant_Api.P2 = "";
            Constant_Api.P3 = "";
            Constant_Api.P4 = "";
    ...
    public static androidx.appcompat.app.AlertDialog loading(Context context) {
        androidx.appcompat.app.AlertDialog dialog = new AlertDialog.Builder(context).setView(LayoutInflater.from(context).inflate(R.layout.progress_dialog, null)).create();
    ...
    public static androidx.appcompat.app.AlertDialog Alert(Context context) {
